...
Route::prefix('inventory')->name('inventory.')->group(function () {
    ...
    Route::get('/{inventoryItem}/edit', [InventoryController::class, 'edit'])->middleware(['permission:inventory.update', 'admin'])->name('edit');
    Route::put('/{inventoryItem}', [InventoryController::class, 'update'])->middleware(['permission:inventory.update', 'admin'])->name('update');
});
