...
Route::prefix('permissions')->name('permissions.')->group(function () {
    ...
    Route::get('/{permission}/edit', [PermissionController::class, 'edit'])->middleware('permission:permission.update,permission.manage')->name('edit');
    Route::put('/{permission}', [PermissionController::class, 'update'])->middleware('permission:permission.update,permission.manage')->name('update');
