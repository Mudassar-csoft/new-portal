...
Route::prefix('users')->name('users.')->group(function () {
    ...
    Route::post('/{user}/impersonate', [UserController::class, 'impersonate'])->middleware('admin')->name('impersonate');
    Route::delete('/impersonation', [UserController::class, 'leaveImpersonation'])->name('leave-impersonation');
    Route::get('/{user}/edit', [UserController::class, 'edit'])->middleware(['permission:user.update', 'admin'])->name('edit');
    Route::put('/{user}', [UserController::class, 'update'])->middleware(['permission:user.update', 'admin'])->name('update');
