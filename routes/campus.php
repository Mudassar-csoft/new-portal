...
Route::prefix('campus')->name('campus.')->group(function () {
    ...
    Route::get('/{campus}/edit', [CampusController::class, 'edit'])->middleware('permission:campus.update')->name('edit');
    Route::post('/', [CampusController::class, 'store'])->middleware('permission:campus.create')->name('store');
    Route::put('/{campus}', [CampusController::class, 'update'])->middleware('permission:campus.update')->name('update');
