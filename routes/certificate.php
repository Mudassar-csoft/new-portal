...
Route::prefix('certificate')->name('certificate.')->group(function () {
    ...
    Route::patch('/bulk-approve', [CertificateController::class, 'bulkApprove'])->middleware('permission:certificate.approve')->name('bulk-approve');
    Route::patch('/bulk-send-to-printing', [CertificateController::class, 'bulkSendToPrinting'])->middleware('permission:certificate.send-to-printing')->name('bulk-send-to-printing');
