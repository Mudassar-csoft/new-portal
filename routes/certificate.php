...
Route::prefix('certificate')->name('certificate.')->group(function () {
    ...
    Route::get('/{certificate}/edit', [CertificateController::class, 'edit'])->middleware('permission:certificate.update')->name('edit');
    Route::put('/{certificate}', [CertificateController::class, 'update'])->middleware('permission:certificate.update')->name('update');
