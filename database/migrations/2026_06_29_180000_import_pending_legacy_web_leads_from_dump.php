...
{
    private const IMPORT_TAG = 'legacy_pending_web_leads_2026_06_29';
    ...
    private function resolveSourcePath(): string
    {
        ...
        throw new RuntimeException(
            'Missing legacy web leads dump. Put `web_leads (1).sql` or `web_leads.sql` in storage/app/legacy-import, storage/app/private/legacy-import, legacy-import/, database/seeders/data/, or your Downloads folder.'
        );
    }
