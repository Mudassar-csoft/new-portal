...
<div class="dropdown registration-action-dropdown">
	...
	<div class="dropdown-menu dropdown-menu-right" aria-labelledby="{{ $actionId }}">
		...
		<a class="dropdown-item" href="#"><i class="fa fa-exchange mr-2 text-warning"></i>Transfer</a>
		<a class="dropdown-item" href="#"><i class="fa fa-file-pdf-o mr-2 text-danger"></i>Receipt</a>
	</div>
</div>
