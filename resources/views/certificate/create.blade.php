...
@push('styles')
    <style>
        :root {
            --dimension-certificate-create-1: 100vh;
            --dimension-certificate-create-2: 12px;
            --space-certificate-create-1: 8px;
            --color-certificate-create-1: #1f2937;
            --color-certificate-create-2: #343434;
            --typo-certificate-create-font-weight-1: 600;
        }

        .lead-shell { font-family: 'Proxima Nova', sans-serif; position: relative; min-height: var(--dimension-certificate-create-1); width: 100%; overflow: visible; padding: 0; margin: 0; }
        .lead-loader { position: absolute; top: 0; left: 0; right: 0; height: var(--dimension-certificate-create-1); background: rgba(245,247,251,0.95); display: flex; align-items: center; justify-content: center; flex-direction: column; z-index: 10; gap: 12px; }
        .lead-spinner { display: inline-flex; align-items: center; gap: var(--space-certificate-create-1); }
        .lead-spinner .dot { width: var(--dimension-certificate-create-2); height: var(--dimension-certificate-create-2); border-radius: 50%; background: #12a0ff; animation: bounce 0.9s ease-in-out infinite; }
