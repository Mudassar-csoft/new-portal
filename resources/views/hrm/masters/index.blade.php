    ...
    <div class="hrm-shell">
        ...
        <div class="row">
                ...
                <section class="box-typical box-typical-dashboard panel panel-default hrm-card">
                    ...
                    <div class="box-typical-body panel-body">
                        <form method="POST" action="{{ route('hrm.masters.leave-types.store') }}" class="mb-3">
                            @csrf
                            <div class="form-row">
                                <div class="form-group col-md-4"><input type="text" class="form-control" name="name" placeholder="Name" required></div>
            ...
            <div class="col-lg-6">
                <section class="box-typical box-typical-dashboard panel panel-default hrm-card">
                    <header class="box-typical-header panel-heading">
                        <h3 class="panel-title">Holidays Calendar</h3>
                    </header>
                    <div class="box-typical-body panel-body">
                        <form method="POST" action="{{ route('hrm.masters.holidays.store') }}" class="mb-3">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3"><input type="text" class="form-control" name="name" placeholder="Holiday Name" required></div>
                                <div class="form-group col-md-3"><input type="date" class="form-control" name="holiday_date" required></div>
                                <div class="form-group col-md-2"><input type="text" class="form-control" name="holiday_type" placeholder="Type"></div>
                                <div class="form-group col-md-1"><button class="btn btn-inline btn-primary-outline w-100" type="submit">Save</button></div>
                            </div>
                        </form>
