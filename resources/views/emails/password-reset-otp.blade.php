        ...
        <tr>
            <td>
                ...
                <table cellpadding="6" cellspacing="0" border="0" style="margin: 16px 0; border: 1px solid #e2e8f0; border-radius: 6px; width: 100%;">
                    <tr><td style="{{ $emailWeightSemibold }} color: #54667a; width: 40%;">Name</td><td>{{ $user->name }}</td></tr>
                    <tr><td style="{{ $emailWeightSemibold }} color: #54667a;">Email</td><td>{{ $user->email }}</td></tr>
                    <tr><td style="{{ $emailWeightSemibold }} color: #54667a;">Request IP</td><td>{{ $requestIp }}</td></tr>
                    <tr><td style="{{ $emailWeightSemibold }} color: #54667a;">Expires</td><td>{{ $expiresAt }}</td></tr>
                </table>
                ...
                <div style="background: #f3f8ff; border: 1px solid #cfe0f5; border-radius: 8px; padding: 24px; text-align: center; margin: 16px 0;">
                    ...
                    <div style="{{ $emailTextSmall }} color: #5b6b80; margin-top: 8px;">One-time password — expires in 15 minutes</div>
                </div>
                <p style="{{ $emailTextSmall }} color: #8a99a8;">If you did not expect this request, you may safely ignore it. The OTP will expire automatically.</p>
            </td>
        </tr>
    </table>
</body>
