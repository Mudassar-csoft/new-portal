                ...
                <form method="POST" action="{{ route('users.store') }}" class="user-form">
                    ...
                    <div class="user-form-row">
                        ...
                        <div class="user-form-field">
                            <input type="text" name="name" id="name" class="form-control user-input @error('name') is-invalid @enderror" placeholder="Alex Morgan" value="{{ old('name') }}" required>
                            @error('name')
                    ...
                    <div class="user-form-row">
                        ...
                        <div class="user-form-field">
                            <input type="email" name="email" id="email" class="form-control user-input @error('email') is-invalid @enderror" placeholder="admin@example.com" value="{{ old('email') }}" required>
                            @error('email')
                                <div class="field-error">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="user-form-row">
                        ...
                        <div class="user-form-field">
                            <div class="input-shell">
                                <input type="password" name="password" id="password" class="form-control user-input user-input-password @error('password') is-invalid @enderror" placeholder="********" autocomplete="new-password" required>
                    ...
                    <div class="user-form-row">
                        ...
                        <div class="user-form-field">
                            <div class="input-shell">
                                <input type="password" name="password_confirmation" id="password_confirmation" class="form-control user-input user-input-confirm @error('password_confirmation') is-invalid @enderror" placeholder="********" autocomplete="new-password" required>
                                <div class="input-shell-actions">
                    ...
                    <div class="user-form-row">
                        ...
                        <div class="user-form-field">
                            <select name="campus_id" id="campus_id" class="form-control select2 select2-white @error('campus_id') is-invalid @enderror" style="width: 100%;" data-placeholder="- Select Campus -">
                    ...
                    <div class="user-form-row">
                        ...
                        <div class="user-form-field">
                            <select name="role_id" id="role_id" class="form-control select2 select2-white @error('role_id') is-invalid @enderror" style="width: 100%;" data-placeholder="Select role">
                    ...
                    <div class="account-activation">
                        <h4 class="account-activation-title">ACCOUNT ACTIVATION</h4>
                        <div class="account-activation-note">
                            <i class="fa fa-info-circle" aria-hidden="true"></i>
                            <span>A setup link will be emailed to the new user. The link is valid for <strong>1 hour</strong> - the user clicks it to set their own password and activate the account.</span>
                        </div>
                    </div>
