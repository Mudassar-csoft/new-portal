    ...
    <ul class="side-menu-list">
        ...
        @if($showStudentModule)
            <li class="magenta with-sub">
                ...
                <ul>
                    @if($canStudentView)
                        <li><a href="{{ route('student.records.index', ['scope' => 'active']) }}" class="stage-link"><span class="lbl">Current Students</span><span class="label label-custom label-pill label-danger stage-count">{{ number_format((int) ($sidebarCounts['student_active'] ?? 0)) }}</span></a></li>
                        <li><a href="{{ route('student.records.index', ['scope' => 'frozen']) }}" class="stage-link"><span class="lbl">Freez Students</span><span class="label label-custom label-pill label-danger stage-count">{{ number_format((int) ($sidebarCounts['student_frozen'] ?? 0)) }}</span></a></li>
                        <li><a href="{{ route('student.records.index', ['scope' => 'concluded']) }}" class="stage-link"><span class="lbl">Concluded Students</span><span class="label label-custom label-pill label-danger stage-count">{{ number_format((int) ($sidebarCounts['student_concluded'] ?? 0)) }}</span></a></li>
                        ...
                        <li><a href="{{ route('student.records.index', ['scope' => 'suspended']) }}" class="stage-link"><span class="lbl">Suspended Student</span><span class="label label-custom label-pill label-danger stage-count">{{ number_format((int) ($sidebarCounts['student_suspended'] ?? 0)) }}</span></a></li>
                        <li><a href="{{ route('student.records.index', ['scope' => 'admission_cancelled']) }}" class="stage-link"><span class="lbl">Enrollment Cancel</span><span class="label label-custom label-pill label-danger stage-count">{{ number_format((int) ($sidebarCounts['student_admission_cancelled'] ?? 0)) }}</span></a></li>
                        <li><a href="{{ route('student.records.index', ['scope' => 'dropped']) }}" class="stage-link"><span class="lbl">Dropped Students</span><span class="label label-custom label-pill label-danger stage-count">{{ number_format((int) ($sidebarCounts['student_dropped'] ?? 0)) }}</span></a></li>
                        ...
                        <li><a href="{{ route('student.records.index', ['scope' => 'alumni']) }}" class="stage-link"><span class="lbl">Alumni Students</span><span class="label label-custom label-pill label-danger stage-count">{{ number_format((int) ($sidebarCounts['student_alumni'] ?? 0)) }}</span></a></li>
                    @endif
                </ul>
            </li>
        @endif
