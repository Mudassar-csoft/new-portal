...
<head lang="en">
	...
	<style>
		...
		.side-menu .brown .stage-count {
			background-color: #c77d16;
			border-color: #c77d16;
		}

		.side-menu .purple .stage-count {
			background-color: #6f42c1;
			border-color: #6f42c1;
		}

		.side-menu .orange .stage-count {
			background-color: #ff9800;
			border-color: #ff9800;
		}

		.side-menu .magenta .stage-count {
			background-color: #e83e8c;
			border-color: #e83e8c;
		}

		.side-menu .blue .stage-count {
			background-color: #0088cc;
			border-color: #0088cc;
		}

		.side-menu .green .stage-count {
			background-color: #28a745;
			border-color: #28a745;
		}

		.side-menu .orange-red .stage-count {
			background-color: #ff5722;
			border-color: #ff5722;
		}

		.side-menu .teal .stage-count {
			background-color: #00897b;
			border-color: #00897b;
		}

		.side-menu .gold .stage-count {
			background-color: #d4a017;
			border-color: #d4a017;
		}

		/* Sidebar sizing tuned per breakpoint */
		...
		/* Mobile: overlay menu, no content shift */
		@media (max-width: 991px) {
			...
			/* Tighter mobile labels to avoid wrapping */
			.side-menu .lbl {
				font-size: 14px;
				line-height: 1.3;
			}
		...
		/* Content area: keep centered and roomy on large screens */
		.with-side-menu .page-content {
		...
		/* When menu is hidden, let content span full width */
		...
		/* Desktop toggle: hide sidebar and reclaim space */
