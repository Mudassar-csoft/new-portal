        ...
        style="height: 31px; width: 31px;">
            ...
            <div class="dropdown dropdown-notification notif">
                <a href="#" class="header-alarm dropdown-toggle active" id="dd-notification"
                  ...
                  @php($headerNotificationTotal = (int) ($notificationTotal ?? ((int) ($webLeadNotificationTotal ?? 0) + (int) ($followupNotificationCount ?? 0) + (int) ($pendingFollowupNotificationCount ?? 0) + (int) ($invoiceOverdueNotificationCount ?? 0) + (int) ($coworkingDueNotificationCount ?? 0))))
