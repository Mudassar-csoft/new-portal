...
@push('styles')
    <style>
        ...
        .lead-loader p { margin: 0; color: #54667a; font-weight: var(--typo-profile-show-font-weight-1); }
        ...
        .lead-create-card label, .lead-create-card .form-label { color: #343434; font-size: var(--typo-profile-show-font-size-2); font-weight: var(--typo-profile-show-font-weight-1); line-height: 1.2; margin-bottom: 6px; }
        .lead-create-card .form-control { font-size: var(--typo-profile-show-font-size-3); height: 37px !important; min-height: 37px !important; padding: 0.375rem 0.625rem !important; border: 1px solid #ccc; border-radius: 0.25rem; color: #343434; }
        ...
        .label-mute { color: #54667a; font-weight: var(--typo-profile-show-font-weight-1); margin-right: 4px; }
