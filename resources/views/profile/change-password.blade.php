                    ...
                    <div class="tbl w-100">
                        <div class="tbl-row">
                            ...
                            <div class="tbl-cell text-right" style="width: 200px;">
                                <a href="{{ route('profile.show') }}" class="btn btn-inline btn-default" style="padding: 0.4rem; padding-left:10px;">Back to Profile</a>
                            </div>
                        </div>
                    </div>
                </header>
                ...
                <div class="box-typical-body panel-body lead-body">
                    ...
                    <form method="POST" action="{{ route('profile.update-password') }}">
                        ...
                        <div class="form-actions mb-2 mt-3 text-right mr-0">
                            <button type="submit" class="btn btn-inline btn-primary-outline" style="padding: 0.4rem; padding-left:10px;">Update Password</button>
                            <a href="{{ route('profile.show') }}" class="btn btn-inline btn-danger-outline" style="padding: 0.4rem; padding-left:10px;">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
