...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: Arial, sans-serif; }
        ...
        p.subtitle { text-align: center; font-size: 13px; margin-bottom: 22px; opacity: 0.9; }
        ...
        .flash { padding: 10px 12px; border-radius: 8px; background: rgba(255,255,255,0.18); margin-bottom: 16px; font-size: 13px; }
        ...
        .otp-input input { letter-spacing: 14px; text-align: center; font-size: 20px; font-weight: 700; }
        .footer-links { text-align: center; margin-top: 16px; font-size: 12px; }
