...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: Arial, sans-serif; }
        ...
        h2 { text-align: center; font-size: 1.375rem; margin: 8px 0 12px; }
        .user-info { text-align: center; font-size: var(--typo-auth-user-setup-font-size-1); margin-bottom: 22px; opacity: 0.92; }
        .user-info strong { display: block; font-size: 0.875rem; margin-top: 4px; }
        ...
        .field-error { margin-top: var(--space-auth-user-setup-2); font-size: 0.75rem; color: #fff6f6; }
